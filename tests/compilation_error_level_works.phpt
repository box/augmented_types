...
?>
--EXPECTREGEX--
Warning: Function annotation compilation failed for function invalid1 in file .*invalid1.php at line (\d)*, error message: You MUST specify a type for all parameters
.*
